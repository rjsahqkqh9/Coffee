...
import com.platformeight.coffee.MainActivity;
import com.platformeight.coffee.R;
import com.platformeight.coffee.servertask.ServerHandle;

import static com.platformeight.coffee.MyApplication.device_token;
...
public class FCMService extends FirebaseMessagingService {
    ...
    private void sendRegistrationToServer(String token) {
        ...
        if (user.getNo()>0) new ServerHandle().setToken(user.getNo(),"coffee_members",token);
