...
public final class Constant {
    ...
    public static final String packageNmae = "com.platform8.searchforcompany";
    //TODO: 앱배포전 도메인 주소변경
    ...
    public static final String colorGray = "#e0e0e0";
    public static final String colorGray2 = "#a0a0a0";
}
