...
import com.platformeight.coffee.ShopListFragment.OnListFragmentInteractionListener;
...
public class MyShopRecyclerViewAdapter extends RecyclerView.Adapter<MyShopRecyclerViewAdapter.ViewHolder> {
    ...
    public MyShopRecyclerViewAdapter(List<DummyItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
